...
import menkalai.baloongame.utils.AppHelper;
import menkalai.baloongame.utils.SimpleAlertDialog;
import menkalai.baloongame.utils.SoundHelper;
...
public class MainActivity extends AppCompatActivity implements Balloon.BalloonListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBalloonColors[3] = Color.argb(255, 255, 255, 255);
        mBalloonColors[4] = Color.argb(255, 255, 255, 0);
        mBalloonColors[5] = Color.argb(0, 0, 0, 0);
        mBalloonColors[6] = Color.argb(128, 0, 128, 128);
        ...
        mScore = AppHelper.getTopScore(this);
        mLevel = AppHelper.getLevel(this);
    ...
    private void gameOver(boolean allPinsUsed) {
        ...
        if (allPinsUsed) {
            if (AppHelper.isTopScore(this, mScore) && AppHelper.isLevel(this, mLevel)) {
